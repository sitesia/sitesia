...
?>
      ...
      <div class="heading_container" id="11">
        <h2>
...
$type ="titre,texte";$sel="11";$tailImg="";include("admin/inc_appel_lien_modifier.php");
?></div>
...
<!-- service -->
      ...
      <div class="service_container" id="12" style="padding-bottom:0px;">

      <?php 

   $limite = 200;
    $emplacement = "nom_de_lemplacement";
    $reqa->execute();
...
?>
      ...
      <div class="textecentre"><?php 
$type ="image,titre,texte";$sel="12";$tailImg="";include("admin/inc_appel_lien_modifier.php");
?></div>
  ...
  <div class="footer_bg">
    ...
    <!-- contact section -->
    <section class="contact_section layout_padding" id="contactLink"  style="padding-top:0px;">
      <div class="container">
...
?>
          ...
          <div class="col-md-3" id="13">
            ...
            <div class="textecentre"><?php 
$type ="titre,texte";$sel="13";$tailImg="";include("admin/inc_appel_lien_modifier.php");
?></div>
          </div>
